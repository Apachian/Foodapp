        ...
        <Row>
          <Carousel>
            <Carousel.Item>
              <Carousel.Caption>
                <div className="user-image">
                  <img src={user1} className="img-fluid" alt="img" />
                </div>
                <p>
            ...
            <Carousel.Item>
              <Carousel.Caption>
                <div className="user-image">
                  <img src={user2} className="img-fluid" alt="img" />
                </div>
                <p>
                  " Etiam sapien sem at sagittis congue augue massa varius
                  sodales sapien undo tempus dolor egestas magna suscipit magna
            ...
            <Carousel.Item>
              <Carousel.Caption>
                <div className="user-image">
                  <img src={user3} className="img-fluid" alt="img" />
                </div>
                <p>
                  " Etiam sapien sem at sagittis congue augue massa varius
                  sodales sapien undo tempus dolor egestas magna suscipit magna
            ...
            <Carousel.Item>
              <Carousel.Caption>
                <div className="user-image">
                  <img src={user4} className="img-fluid" alt="img" />
                </div>
                <p>
                  " Etiam sapien sem at sagittis congue augue massa varius
                  sodales sapien undo tempus dolor egestas magna suscipit magna
