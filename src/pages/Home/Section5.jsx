              ...
              <Carousel.Item>
                <Carousel.Caption>
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="brand-image">
                      <img src={Brand3} className="img-fluid" alt="img" />
                    </div>
                    ...
                    <div className="brand-image">
                      <img src={Brand8} className="img-fluid" alt="img" />
                    </div>
              ...
              <Carousel.Item>
                <Carousel.Caption>
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <div className="brand-image">
                      <img src={Brand6} className="img-fluid" alt="img" />
                    </div>

                    <div className="brand-image">
                      <img src={Brand7} className="img-fluid" alt="img" />
                    </div>
